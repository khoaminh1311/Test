...
public class TextBook extends Book {
    ...
    public void addBook()  {
        ...
        scanner.nextLine();
        System.out.print("Enter the status for this book: ");
    ...
    public void displayBook()  {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        System.out.println("Text Book ID: " + getBookId() + ", publisher: " + getPublisher() + ", entry date: " + dateFormat.format(getEntryDate()) + ", quantity: " + getQuantity() + ", unit price: " + getUnitPrice() + ", status: " + this.status);
    }
}
